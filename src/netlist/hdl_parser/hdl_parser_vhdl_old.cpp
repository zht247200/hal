...
//         for (const auto sig : get_vector_signals(base_name, type))
//         {
//             e.ports.emplace_back(sig, direction);
//             e.expanded_signal_names[base_name].push_back(sig);
//         }
//     }
//     m_token_stream.consume(")", true);
//     m_token_stream.consume(";", true);
...
//             // add all (sub-)signals
//             for (const auto sig : get_vector_signals(name, type))
//             {
//                 e.expanded_signal_names[name].push_back(sig);
//                 e.signals.push_back(sig);
//             }
//         }
