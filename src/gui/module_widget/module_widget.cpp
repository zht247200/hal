...
{
    connect(m_tree_view->selectionModel(), &QItemSelectionModel::selectionChanged, this, &module_widget::handle_intern_selection_changed);
    connect(m_tree_view, &QTreeView::customContextMenuRequested, this, &module_widget::handle_custom_context_menu_requested);
...
void module_widget::handle_intern_selection_changed(const QItemSelection& selected, const QItemSelection& deselected)
{
    Q_UNUSED(selected)
    Q_UNUSED(deselected)
...
void module_widget::handle_custom_context_menu_requested(const QPoint& point)
{
