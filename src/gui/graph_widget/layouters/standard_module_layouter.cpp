...
void standard_module_layouter::add(const QSet<u32> modules, const QSet<u32> gates, const QSet<u32> nets)
{
...
void standard_module_layouter::remove(const QSet<u32> modules, const QSet<u32> gates, const QSet<u32> nets)
{   
//    m_modules -= modules;
//    m_gates -= gates;
//    m_nets -= nets;
