#include "graph_widget/layouters/minimal_module_layouter.h"
...
minimal_module_layouter::minimal_module_layouter(module_context* context) : module_layouter(context)
{

}

QString minimal_module_layouter::name() const
{
    return "Minimal Layouter";
}

QString minimal_module_layouter::description() const
{
    return "<p>PLACEHOLDER</p>";
}

void minimal_module_layouter::layout()
{
    assert(m_context);
