/*
#ifndef STANDARD_MODULE_LAYOUTER_V2_H
#define STANDARD_MODULE_LAYOUTER_V2_H
...
class standard_module_layouter_v2 final : public module_layouter
{
    struct node_level
    {
        hal::node node;
...
public:
    standard_module_layouter_v2(const module_context* const context);
...
#endif // STANDARD_MODULE_LAYOUTER_V2_H
*/
