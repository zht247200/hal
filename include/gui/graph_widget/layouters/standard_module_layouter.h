#ifndef STANDARD_MODULE_LAYOUTER_H
#define STANDARD_MODULE_LAYOUTER_H
...
class standard_module_layouter final : public module_layouter
{
    struct node_level
    {
        hal::node node;
...
#endif // STANDARD_MODULE_LAYOUTER_H
